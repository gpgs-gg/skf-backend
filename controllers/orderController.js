...
// //         // Existing attachments sent from frontend
// //         const incomingAttachments = parsed.attachments || [];
...
// //         // Preserve attachments sent by frontend
// //         product.attachments = incomingAttachments;
// //       } else {
// //         product[key] = req.body[key];
// //       }
...
// //       // Merge uploaded files with existing attachments
// //       product.attachments = [...(product.attachments || []), ...uploadedFiles];
// //     }

// //     console.log("ATTACHMENTS AFTER MERGE:", product.attachments);

// //     // =========================
// //     // 3. RECALCULATE PRODUCT TOTAL
// //     // =========================
// //     product.total = (product.price || 0) * (product.quantity || 1);
